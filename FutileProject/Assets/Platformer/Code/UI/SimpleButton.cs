...
namespace Platformer
{
	public class SimpleButton : FContainer
	{
		...
		public SimpleButton (string title, float width, float height, SimpleButtonColor color, bool isPressTap) : this(title,width,height,color,isPressTap,Fonts.MEDIUM_BOLD)
		{
		...
		public bool canTapWhileDisabled {
			...
			set { 
				if (_canTapWhileDisabled != value) {
					_canTapWhileDisabled = value;
					UpdateEnabled ();
				}}
		}
		...
		public float width {
			...
			set { 
				if (button.width != value) {
					button.width = value;
					_overHighlight.width = value;
				}}
		}
		...
		public float height {
			...
			set { 
				if (button.height != value) {
					button.height = value;
					_overHighlight.height = value;
				}}
		}
