...
namespace Platformer
{
	public class Blocker : FButton
	{
		...
		public void Show (float duration)
		{
			...
			Go.to (this, duration, new GoTweenConfig ().floatProp ("alpha", 1.0f).onComplete (HandleShowComplete));
		}
		...
		public void Hide ()
		{
			...
			Go.killAllTweensWithTarget (this);
			Go.to (this, hideDuration, new GoTweenConfig ().floatProp ("alpha", 0.0f).onComplete (HandleHideComplete));
		}
